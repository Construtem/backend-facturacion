...
func GetOrCreateInvoiceData(quotePreviewID uint) (*models.Factura, error) {
	...
	// CREAR FACTURA CON DATOS QUE VIENEN DE OTRAS CELDAS/TABLAS
	...
	// CREAR DETALLES FICTICIOS O REALES (según tu necesidad)
	// Estos también se guardan directamente en la tabla factura como JSONB
